    ...
    <>
      <nav className="sticky top-0 z-50 bg-white border-b border-gray-200">
        ...
        <div className="max-w-[1600px] mx-auto px-4 h-14 md:h-16 flex items-center justify-between gap-4">
          ...
          {/* Icons in order: Profile, Wishlist, Cart, Menu */}
        ...
        {/* Mobile Search Bar - Increased border thickness */}
        <div className="md:hidden px-4 pb-3">
          <div className="flex items-center bg-transparent border-2 border-[var(--fn-border)] rounded-full px-4 py-2">
            <Icons.Search />
            <input 
              type="text" 
              placeholder="Search within Women's Clothing" 
        ...
        {/* Promotion Image Tab - True to size */}
